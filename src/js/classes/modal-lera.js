...
class ModalLera {
  ...
  <div class="col-md-12">
      ...
      <input type="email" class="form-control" id="inputNameDentist" placeholder="John Doe" >
  </div>
  <div class="col-12">
      <label for="inputWorriesDentist" class="form-label">Purpose of visit</label>
      <input type="text" class="form-control" id="inputWorriesDentist" placeholder="What troubles you?" >
  </div>
  <div class="col-12">
